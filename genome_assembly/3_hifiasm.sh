...
hifiasm -o Pogonus_hifiasm.asm --n-hap 2 --hom-cov 34 -t 32 --h1 GC143248_ACTCTCGA-TGGTACAG_S65_L001_R1_001.fastq.gz --h2 GC143248_ACTCTCGA-TGGTACAG_S65_L001_R2_001.fastq.gz POG_HiFi_reads.fastq.gz
