...
merged_GC129388_dud10$population <- "Dudzele"
...
merged_GC129389_dud10$population <- "Dudzele"
...
merged_GC129394_dud10$population <- "Nieuwpoort"
...
merged_GC129395_dud10$population <- "Nieuwpoort"
...
merged_GC129388_nieu10$population <- "Dudzele"
...
merged_GC129389_nieu10$population <- "Dudzele"
...
merged_GC129394_nieu10$population <- "Nieuwpoort"
...
merged_GC129395_nieu10$population <- "Nieuwpoort"
...
ggplot(NIEU10, aes(x = genomic_position, y = normalized_coverage, color=population)) +
  geom_line() +
