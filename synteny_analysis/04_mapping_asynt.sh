...
samtools faidx LG01_dud.fasta CM008230.1_RagTag:9100059-39608137 > scaffold_A_dud.fasta
...
minimap2 -x asm10 scaffold_B_dud.fa scaffold_B_nieu.fa | gzip > scaffold_B.paf.gz
minimap2 -x asm10 scaffold_C_dud.fa scaffold_C_nieu.fa | gzip > scaffold_C.paf.gz
minimap2 -x asm10 scaffold_D_dud.fa scaffold_D_nieu.fa | gzip > scaffold_D.paf.gz
minimap2 -x asm10 scaffold_E_dud.fa scaffold_E_nieu.fa | gzip > scaffold_E.paf.gz
minimap2 -x asm10 scaffold_F_dud.fa scaffold_F_nieu.fa | gzip > scaffold_F.paf.gz
minimap2 -x asm10 scaffold_G_dud.fa scaffold_G_nieu.fa | gzip > scaffold_G.paf.gz
minimap2 -x asm10 scaffold_H_dud.fa scaffold_H_nieu.fa | gzip > scaffold_H.paf.gz
