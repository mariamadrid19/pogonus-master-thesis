...
python denovo_synteny_block_stats.py --tsv synteny_all_haps.synteny_blocks.tsv --fai dh1_50_scaffolds.fasta.fai sorted_dh2.fasta.fai sorted_nh1.fasta.fai sorted_nh2.fasta.fai

python sort_ntsynt_blocks.py --synteny_blocks synteny_all_haps.synteny_blocks.tsv --sort_order dh1_50_scaffolds.fasta.fai sorted_dh2.fasta.fai sorted_nh1.fasta.fai sorted_nh2.fasta.fai --fais > synteny_all_haps.synteny_blocks.sorted.tsv

python format_blocks_gggenomes.py --fai dh1_50_scaffolds.fasta.fai sorted_dh2.fasta.fai sorted_nh1.fasta.fai sorted_nh2.fasta.fai --prefix synteny_all_haps --blocks synteny_all_haps.synteny_blocks.sorted.tsv --length 100 --colour dh1_50_scaffolds.fasta
